...
namespace Entitas {
    public partial class Entity {
        public RMC.EntitasTemplate.Entitas.Components.AIComponent aI { get { return (RMC.EntitasTemplate.Entitas.Components.AIComponent)GetComponent(ComponentIds.AI); } }
        ...
        public Entity AddAI(Entitas.Entity newTargetEntity, float newDeadZoneY, float newVelocityY) {
            var component = CreateComponent<RMC.EntitasTemplate.Entitas.Components.AIComponent>(ComponentIds.AI);
