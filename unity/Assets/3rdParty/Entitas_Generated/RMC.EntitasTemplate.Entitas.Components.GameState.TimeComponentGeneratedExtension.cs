...
namespace Entitas {
    public partial class Entity {
        public RMC.EntitasTemplate.Entitas.Components.GameState.TimeComponent time { get { return (RMC.EntitasTemplate.Entitas.Components.GameState.TimeComponent)GetComponent(ComponentIds.Time); } }
        ...
        public Entity AddTime(float newTimeSinceGameStartUnpaused, float newTimeSinceGameStartTotal, bool newIsPaused) {
            var component = CreateComponent<RMC.EntitasTemplate.Entitas.Components.GameState.TimeComponent>(ComponentIds.Time);
    ...
    public partial class Pool {
        ...
        public RMC.EntitasTemplate.Entitas.Components.GameState.TimeComponent time { get { return timeEntity.time; } }
        ...
        public Entity SetTime(float newTimeSinceGameStartUnpaused, float newTimeSinceGameStartTotal, bool newIsPaused) {
            if (hasTime) {
                throw new EntitasException("Could not set time!\n" + this + " already has an entity with RMC.EntitasTemplate.Entitas.Components.GameState.TimeComponent!",
