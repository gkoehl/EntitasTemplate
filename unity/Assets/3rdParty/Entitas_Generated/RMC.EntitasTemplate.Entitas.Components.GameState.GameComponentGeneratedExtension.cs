...
namespace Entitas {
    public partial class Entity {
        public RMC.EntitasTemplate.Entitas.Components.GameState.GameComponent game { get { return (RMC.EntitasTemplate.Entitas.Components.GameState.GameComponent)GetComponent(ComponentIds.Game); } }

        public bool hasGame { get { return HasComponent(ComponentIds.Game); } }

        public Entity AddGame(int newDummy) {
            var component = CreateComponent<RMC.EntitasTemplate.Entitas.Components.GameState.GameComponent>(ComponentIds.Game);
    ...
    public partial class Pool {
        ...
        public RMC.EntitasTemplate.Entitas.Components.GameState.GameComponent game { get { return gameEntity.game; } }

        public bool hasGame { get { return gameEntity != null; } }

        public Entity SetGame(int newDummy) {
            if (hasGame) {
                throw new EntitasException("Could not set game!\n" + this + " already has an entity with RMC.EntitasTemplate.Entitas.Components.GameState.GameComponent!",
