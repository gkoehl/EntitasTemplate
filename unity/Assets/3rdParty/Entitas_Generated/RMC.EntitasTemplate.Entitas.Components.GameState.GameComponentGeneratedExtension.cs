...
namespace Entitas {
    public partial class Entity {
        static readonly RMC.EntitasTemplate.Entitas.Components.GameState.GameComponent gameComponent = new RMC.EntitasTemplate.Entitas.Components.GameState.GameComponent();
