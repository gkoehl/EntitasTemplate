...
namespace Entitas {
    public partial class Entity {
        public RMC.EntitasTemplate.Entitas.Components.ScoreComponent score { get { return (RMC.EntitasTemplate.Entitas.Components.ScoreComponent)GetComponent(ComponentIds.Score); } }
        ...
        public Entity AddScore(int newWhiteScore, int newBlackScore) {
            var component = CreateComponent<RMC.EntitasTemplate.Entitas.Components.ScoreComponent>(ComponentIds.Score);
    ...
    public partial class Pool {
        ...
        public RMC.EntitasTemplate.Entitas.Components.ScoreComponent score { get { return scoreEntity.score; } }

        public bool hasScore { get { return scoreEntity != null; } }

        public Entity SetScore(int newWhiteScore, int newBlackScore) {
            if (hasScore) {
                throw new EntitasException("Could not set score!\n" + this + " already has an entity with RMC.EntitasTemplate.Entitas.Components.ScoreComponent!",
